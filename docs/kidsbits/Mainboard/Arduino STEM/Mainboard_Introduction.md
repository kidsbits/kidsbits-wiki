# KD2075 Kidsbits STEM Electronic Building Block Programming Development Controller for Arduino

![Img](./media/Mainboard1.png)

## 1. Introduction：
Kidsuno STEM electronic building block programming development controller is a board based on the ATmega328P microcontroller. It boasts 14 digital input or output pins (6 of which can be used as PWM output), 8 analog inputs (A4 and A5 as fixed I2C), two row pin ports, a USB port, a DC power port, a DC power switch, a reset button and a 128*64 OLED display.
